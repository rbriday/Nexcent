        ...
        <div className='bg-[#F5F7FA] py-[32px]'>
            <Container>
                <div className='md:flex'>
                    ...
                    <div className='md:w-[748px] py-[10px]'>
                        <div>
                            ...
                            <h4 className='font-primary font-semibold text-[20px] text-btnColor leading-[28px] pt-[30px] md:pt-0]'>Tim Smith</h4>
                            <p className='font-primary text-secondary text-[16px] leading-[24px]'>British Dragon Boat Racing Association</p>
                        </div>
                        <div className='mt-[10px] md:flex justify-between items-center'>
                            <div className='md:w-[493px] flex justify-between'>
                            ...
                            <div className='w-[223px] mt-[10px] md:mt-[10px]'>
